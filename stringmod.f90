module strings
  !Real kinds(used for the module strings)
  integer, parameter :: kr4 = selected_real_kind(6,37)!single real
  integer, parameter :: kr8 = selected_real_kind(15,307)!double real
  !Integer kinds(used for the module strings)
  integer, parameter :: ki4 = selected_int_kind(9)!single integer
  integer, parameter :: ki8 = selected_int_kind(18)!double integer
